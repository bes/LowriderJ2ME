...
public class LWRGameEventMultiplayerHop extends LWRAbstractGame {
    ...
    public LWRGameEventMultiplayerHop(LWRMonitor lwrMonitor, int gameEnv,
            int gameCar1, int gameCar2) {
        super(lwrMonitor);
        this.gameCar2 = gameCar2;
        this.gameEnv = gameEnv;

        game = new LWRGameEventHop(lwrMonitor, gameEnv, gameCar1, true);
    }
    ...
    public void keyPressed(int keyCode) {
        if (!totalScoreShown && game.gameOver() && firstRound && keyCode == Canvas.FIRE) {
            ...
            game.flush();
            game = new LWRGameEventHop(lwrMonitor, gameEnv, gameCar2, true);
